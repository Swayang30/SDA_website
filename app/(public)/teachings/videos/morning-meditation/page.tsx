...
const YOUTUBE_ID = "FmZOeu_P1zE";
const FALLBACK_URL =
  "https://swamidebanandaashram.org/teachings/videos/morning-meditation";
...
function ShareModal({
  ...
  const { t } = useLanguage();
  const p = t.morningMeditationPage;
...
export default function MorningMeditationVideoPage() {
  const { t } = useLanguage();
  const p = t.morningMeditationPage;
    ...
    <>
      ...
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: p.breadcrumbTeachings, href: "/teachings" },
          { label: p.breadcrumbPage, href: "/teachings/videos/morning-meditation" },
        ]}
      />
      ...
      <SectionWrapper variant="white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-5">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium text-muted-foreground bg-secondary">
              {p.categoryLabel}
            </span>
          ...
          <div className="flex items-center gap-3 mb-8">
            <Button
              ...
              id="share-morning-meditation-button"
            >
          ...
          <div className="rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-amber-50/50 border border-primary/20 p-6 md:p-8 text-center">
            ...
            <Button
              ...
              id="share-morning-meditation-bottom-button"
            >
              <Share2 className="h-4 w-4" />
              {p.shareButton}
            </Button>
